        ...
        switch (recordType) {
          case 'Weight': {
            ...
            if (rec.time && weight?.inKilograms) {
              ...
              recordDate = getLocalDateString(rec.time as string);
            }
            break;
          }
          ...
          case 'ActiveCaloriesBurned': {
            ...
            if (rec.value !== undefined && rec.date && rec.type === 'Active Calories') {
              ...
              if (rec.startTime && energy?.inCalories != null) {
                ...
                recordDate = getLocalDateString(rec.startTime as string);
                if (index === 0) {
                ...
                recordDate = dateField ? getLocalDateString(dateField) : null;
          ...
          case 'BloodPressure': {
            if (rec.time) {
              const date = getLocalDateString(rec.time as string);
          ...
          case 'BasalMetabolicRate': {
            ...
            if (bmrDate) {
              try {
                bmrDateStr = typeof bmrDate === 'string' ? getLocalDateString(bmrDate) : null;
              } catch (e) {
          ...
          case 'BloodGlucose': {
            ...
            if (glucoseDate) {
              try {
                glucoseDateStr = typeof glucoseDate === 'string' ? getLocalDateString(glucoseDate) : null;
              } catch (e) {
          ...
          case 'BodyFat': {
            ...
            if (dateSource) {
              try {
                bodyFatDate = typeof dateSource === 'string' ? getLocalDateString(dateSource) : null;
              } catch (e) {
          ...
          case 'OxygenSaturation': {
            ...
            if (o2Date) {
              try {
                o2DateStr = typeof o2Date === 'string' ? getLocalDateString(o2Date) : null;
              } catch (e) {
          ...
          case 'Vo2Max': {
            ...
            if (vo2Date) {
              try {
                vo2DateStr = typeof vo2Date === 'string' ? getLocalDateString(vo2Date) : null;
              } catch (e) {
            ...
            if (rec.startTime && samples) {
              samples.forEach(sample => {
                transformedData.push({
                  ...
                  type: outputType,
                  date: getLocalDateString(rec.startTime as string),
                  unit: unit,
                });
              });
            }
            ...
            if (rec.startTime && rec.endTime) {
              ...
              for (let d = new Date(start); d <= end; d.setDate(d.getDate() + 1)) {
                transformedData.push({
                  value: 1,
                  type: outputType,
                  date: getLocalDateString(new Date(d).toISOString()),
                  unit: unit,
                });
              }
            }
